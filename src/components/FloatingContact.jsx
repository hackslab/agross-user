        ...
        {isOpen && (
          <div className="contact-options">
            ...
            >
              ...
              <span>{t("floatingContact.telegram")}</span>
            </a>
            <a
              href="https://wa.me/998974008727"
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              ...
              <span>{t("floatingContact.whatsapp")}</span>
            </a>
            <a href="tel:+99871502636" className="contact-option phone">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path
              ...
              <span>{t("floatingContact.phone")}</span>
            </a>
          </div>
        )}
        <button
